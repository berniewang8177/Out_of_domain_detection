...
def distance_link(
    ...
    dists = {}
    if dist_type == 'mahalanobis_simsiam':
        ...
        if X_train.shape[1] < 2:
            ...
            dists[append_name+dist_type] = np.mean(dist, axis=0)
    elif dist_type == 'euclidean_simsiam':
    ...
    elif dist_type == 'attention_metric_simsiam':
    ...
    elif dist_type == 'attention_metric_ts_ss_simsiam':
    ...
    elif dist_type == 'gpr_std_simsiam':
    ...
    elif dist_type == 'gpr_err_bar_simsiam':
    ...
    elif dist_type == 'oneClassSVM_simsiam':
