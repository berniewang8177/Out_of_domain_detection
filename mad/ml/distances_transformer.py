...
def distance_link(
    ...
    dists = {}
    if dist_type == 'mahalanobis_transformer':
    ...
    elif dist_type == 'cosine_transformer':
        ...
        if X_train.shape[1] < 2:
            ...
            dists[append_name+dist_type] = np.mean(dist, axis=0)
    elif dist_type == 'euclidean_transformer':
    ...
    elif dist_type == 'attention_metric_transformer':
    ...
    elif dist_type == 'attention_metric_ts_ss_transformer':
    ...
    elif dist_type == 'pdf_transformer':
    ...
    elif dist_type == 'gpr_std_transformer':
    ...
    elif dist_type == 'gpr_err_bar_transformer':
    ...
    elif dist_type == 'oneClassSVM_transformer':
    ...
    elif dist_type == 'lof_transformer':
...
def distance(X_train, X_test, y_train=None, y_test=None):
    ...
    distance_list = [
                     ...
                     # 'euclidean_simsiam',
                     # 'oneClassSVM_simsiam',
                     # 'attention_metric_simsiam',
                     # 'attention_metric_ts_ss_simsiam',
                     # 'lof_simsiam',
                     # 'gpr_std_simsiam',
                     # 'gpr_err_bar_simsiam',
                     ]
