...
class builder:
    ...
    def nestedcv(
        ...
        '''
        # df_td is created by stack up all dfs in a list. That list is created by bottom split
        ...
        if model_type in ensemble_methods:
            ...
            df_td = pd.concat(df_td) # # stack up df_td of diff runs, df_td is a list of df
