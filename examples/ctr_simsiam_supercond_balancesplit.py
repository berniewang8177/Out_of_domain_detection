...
from mad.ml import splitters, feature_selectors, domain_simsiam
...
def main():
    ...
    # sim Siamese
    # save = f'Simsiam_supercond__{c}cluser_{r}repeats_err_in_err_binned'
    # save = f'Simsiam_supercond__PGrOut2_{p}%ood_{id_tr}_id_tr_ratio_err_in_err_binned'

    save = f'Simsiam_supercond_leave1ChemiGroup_20repeats_err_in_err_binned'
    ...
    calibration.make_plots(save, points, 'stdcal', 'cosine_simsiam')
    ...
    calibration.make_plots(save, points, 'stdcal', 'mahalanobis_simsiam')
